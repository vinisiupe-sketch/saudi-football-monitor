...
# Treinadores foram tirados de propósito: o TM só registra as trocas da temporada
# corrente, então quem chegou antes (Postecoglou, Wissing) nunca apareceria e o
# post continuaria exigindo complemento manual. Meio caminho não ajuda ninguém.
TM_HEADERS = {
    "User-Agent": (
...
async def run_janela_scrape() -> dict:
    ...
    try:
        ...
        # Os treinadores gravados na versão anterior somem aqui: não estão mais
        # entre os ids da raspagem atual, então esta limpeza os remove sozinha.
