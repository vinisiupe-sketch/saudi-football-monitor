...
KEYWORDS = {
    ...
    "arabic": [
        ...
        # clubes menores e termos gerais
        "الخلود", "القادسية", "الفيحاء", "الحزم", "الخليج",
        "الرياض", "النجمة", "الأخدود", "الوحدة", "ضمك",
        "الفريق", "اللاعب", "المدرب", "الانتقال", "الصفقة",
        "عقد", "إعارة", "دوري روشن السعودي للمحترفين",
    ],
